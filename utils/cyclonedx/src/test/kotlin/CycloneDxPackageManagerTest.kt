...
class CycloneDxPackageManagerTest : StringSpec({
    val packageManager = TestCycloneDxPackageManager()
    ...
    "partition dependencies by scope" should {
        "handle required scope (default)" {
            ...
            result.project.scopeNames shouldBe setOf("dependencies")
        }
        ...
        "handle optional scope" {
            ...
            results shouldHaveSize 1
            val result = results.first()
            result.project.scopeNames shouldBe setOf("optionalDependencies")
        }
        ...
        "handle excluded scope" {
            ...
            results shouldHaveSize 1
            val result = results.first()
            result.project.scopeNames shouldBe setOf("devDependencies")
        }
        ...
        "handle mixed scopes" {
            ...
            results shouldHaveSize 1
            val result = results.first()
            result.project.scopeNames shouldBe setOf("dependencies", "optionalDependencies", "devDependencies")
        }
